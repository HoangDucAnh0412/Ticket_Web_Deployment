...
const OrganizerTransactions = () => {
    ...
    const filteredTransactions = transactions.filter((transaction) => {
        ...
        const matchesEventDate = !eventDateFilter || transactionDate >= new Date(eventDateFilter);

        return matchesSearch && matchesStatus && matchesEvent && matchesEventDate;
    });
    ...
    const revenueStats = {
        total: transactions.reduce((sum, t) => sum + (t.status === "completed" ? t.totalAmount : 0), 0),
        pending: transactions.reduce((sum, t) => sum + (t.status === "pending" ? t.totalAmount : 0), 0),
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600">Monitor transactions for your events</p>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold">{formatAmount(revenueStats.total)}</p>
                        </div>
                ...
                <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl p-6 text-white">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold">{formatAmount(revenueStats.pending)}</p>
                        </div>
                                ...
                                <tr key={transaction.transactionId} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 border-b">
                                        <div>
                                            ...
                                            <div className="text-gray-500 text-xs">{transaction.userEmail}</div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 border-b">
