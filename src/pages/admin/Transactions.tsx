...
const STATS_ENDPOINT = `${BASE_URL}/api/admin/transactions/stats`;
...
const Transactions = () => {
  ...
  const handleSearch = (term: string) => {
    ...
    setSearchInput(term);
    // update actual search term after debounce
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedTransaction.eventInfo.organizerName}
                    </p>
                  </div>
                </div>
              </div>
  ...
  const analytics = {
    ...
    pendingRevenue: transactions.reduce(
        ...
        <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">
                {formatAmount(analytics.pendingRevenue)}
              </p>
            </div>
