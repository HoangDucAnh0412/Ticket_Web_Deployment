...
const TICKETS_ENDPOINT = `${BASE_URL}/api/admin/tickets`;
const STATS_ENDPOINT = `${BASE_URL}/api/admin/tickets/stats`;
...
const Ticket = () => {
  ...
  }, [tickets, statusFilter, eventFilter, dateFilter, searchTerm]);
            ...
            <div className="grid lg:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="text-gray-600 text-sm">Phase ID</p>
                    <p className="font-medium">#{selectedTicket.phaseId}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              ...
              <div className="text-center">
                ...
                <button
                  ...
                  className="text-blue-600 hover:text-blue-800 flex items-center gap-2 mx-auto bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-lg transition-colors"
                >
                  <FaEye size={14} />
                  View Full Size
                </button>
    ...
    <div className="p-6 min-h-screen">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div>
            ...
            <p className="text-l text-gray-500 mt-2">
              Monitor and manage all system tickets
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-green-100 text-sm font-medium">Sold Tickets</p>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
          ...
          <div className="flex-1 max-w-md">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search by customer, event, area, or transaction ID..."
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <table className="w-full text-sm text-left text-gray-700">
          <thead className="bg-gray-100 text-gray-700 text-sm uppercase">
            <tr>
              <th className="px-6 py-3 border-b">Ticket ID</th>
        ...
        <div className="flex justify-center items-center mt-6 gap-2">
          ...
          <div className="flex items-center gap-2 ml-4">
            ...
            <input
              ...
              className="w-16 px-2 py-2 border border-gray-300 rounded text-center text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
