import { FaChevronDown, FaChevronUp, FaEdit, FaTrash, FaSave, FaTimes, FaPlus } from "react-icons/fa";
...
const TicketSalePhases = ({
  ...
  const handleSaveUpdate = async () => {
    ...
    try {
        ...
        prevPhases.map((phase) =>
          phase.phaseId === editingPhase.phaseId
            ? {
                ...
                ticketsAvailable: editingPhase.ticketsAvailable,
                areaId: editingPhase.areaId,
                // Preserve other fields that might not be in EditablePhase but are in Phase
      ...
      // Clear editing mode without closing the accordion
      setEditingPhase(null);
    } catch (err: any) {
